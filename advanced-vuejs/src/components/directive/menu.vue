    ...
    menu: {
      inserted(el, binding) {
        ...
        el.addEventListener('contextmenu', (e) => {
          ...
          // 构建菜单
          let template = `<div id="submenu"><div style="position: fixed;top: 0;left: 0;bottom: 0;right: 0;z-index: 9998;"></div><ul class="list-group" style="width: 200px;position: fixed;top: ${top}px;left: ${left}px;z-index: 9999;">${list}</ul></div>`
          // 渲染到页面
          ...
          // 给菜单添加点击事件
          let li = submenu.querySelectorAll('.list-group-item')
